...
def get_payment_option(payment_method_code):
    ...
    As NEGDi expects the specific card brand (e.g, VISA) rather than the generic 'card' option, we
    skip the mapping and return an empty string when the provided payment method code is 'card'.
    This allows the user to select the desired brand on NEGDi' checkout page.

    :param str payment_method_code: The code of the payment method.
    :return: The corresponding NEGDi' payment option.
    :rtype: str
    """
